...
TEAM_DISPLAY: Dict[str, Tuple[str, str | None]] = {
    ...
    "Espanol": ("RCD Espanyol", "https://crests.football-data.org/80.svg"),
    "Espanyol": ("RCD Espanyol", "https://crests.football-data.org/80.svg"),
    ...
    "RCD Espanyol": ("RCD Espanyol", "https://crests.football-data.org/80.svg"),
